export function MailIcon() {
  return (
    <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <defs>
        <filter id="filter0_i_mail" x="0" y="0" width="22.0001" height="22" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
          ...
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_mail" />
        </filter>
      </defs>
    </svg>
  )
