export function LockIcon() {
  return (
    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <defs>
        <filter id="filter0_i_lock" x="0" y="0" width="18" height="24" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
          ...
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_lock" />
        </filter>
      </defs>
    </svg>
  )
