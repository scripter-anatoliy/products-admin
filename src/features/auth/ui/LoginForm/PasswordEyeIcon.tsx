  ...
  if (visible) {
    return (
      <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        ...
        <defs>
          <filter id="filter0_i_eye" x="0" y="0" width="21.6883" height="24" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
            ...
            <feBlend mode="normal" in2="shape" result="effect1_innerShadow_eye" />
          </filter>
        </defs>
      </svg>
    )
